...
export default function PopularMealsDetail() {
  ...
  return (
    ...
    >
      {/* Back Button */}
    <button
      onClick={() => navigate("/popular")} // replace "/meals" with your actual all meals route
      className="flex items-center gap-2 text-gray-600 hover:text-[#4b9e22] mb-6 transition-colors"
    >
      <FaArrowLeft />
      <span className="font-medium">Back to Popular Recipes</span>
    </button>
